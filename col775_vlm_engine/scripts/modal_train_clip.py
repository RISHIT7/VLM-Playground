...
def train_clip_remote(args: list[str]):
    download_dataset()
    ...
    print(f"Running CLIP training with args: {cli_args}")
    sys.argv = cli_args
...
def main(*args: str):
    ...
    e.g. `modal run scripts/modal_train_clip.py -- --clip-epochs 10`
    """
    train_clip_remote.remote(list(args))
