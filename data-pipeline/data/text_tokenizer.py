...
class CLEVRTokenizer:
    ...
    def build_vocab(self, annotations_file: str):
        ...
        with open(annotations_file, 'r') as f:
            data = json.load(f)
        # Collect all words from captions (lowercase, strip punctuation)
        for item in data:
        ...
        # Assign [EOS] as the largest index
    ...
    def encode(self, text: str) -> Tuple[torch.LongTensor, torch.BoolTensor]:
        ...
        padding_mask = torch.ones(self.max_seq_len, dtype=torch.bool)  # True = pad
